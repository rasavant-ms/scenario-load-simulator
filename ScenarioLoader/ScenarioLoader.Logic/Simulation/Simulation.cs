...
namespace ScenarioLoader.Logic.Simulation
{
        ...
        : ISimulation
    {
        ...
        private Models.Simulation simulation;
        ...
        private void CheckForDeletedSimulation(Models.Simulation newSimulation)
        {
        ...
        private void CheckForChangedSimulation(Models.Simulation newSimulation)
        {
            if (newSimulation != null && this.simulation != null &&
        ...
        private void CheckForNewSimulation(Models.Simulation newSimulation)
        {
            if (newSimulation != null && this.simulation == null)
            {
                this.simulation = newSimulation;
